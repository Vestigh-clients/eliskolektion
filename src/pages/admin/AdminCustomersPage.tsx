    ...
    <>
      ...
      >
        ...
        <div className="space-y-5 px-5 py-4">
          ...
          <div>
            <p className="mb-2.5 font-inter text-[10px] uppercase tracking-[0.18em] text-[var(--color-primary)]">Sort</p>
            <select
              value={sortBy}
              onChange={(event) => {
              ...
              className="h-11 w-full rounded-full border bg-white px-4 font-inter text-[11px] uppercase tracking-[0.1em] text-[var(--color-primary)] outline-none focus:border-[var(--color-primary)]"
    ...
    <div className="admin-page lux-page-enter overflow-visible min-h-[calc(100dvh-3.5rem)] md:min-h-[calc(100dvh-4rem)] flex flex-col">
      <div className="mx-auto flex w-full max-w-[1120px] flex-1 flex-col text-left">
        <div className="flex flex-wrap items-start justify-between gap-3">
          <div>
            <p className="font-inter text-[11px] uppercase tracking-[0.22em] text-[var(--color-primary)]">People</p>
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="hidden border-t border-[rgba(var(--color-primary-rgb),0.1)] pt-4 lg:flex lg:items-start lg:justify-between lg:gap-4">
              ...
              <div className="flex flex-wrap items-center justify-end gap-2">
                <p className="font-inter text-[10px] uppercase tracking-[0.16em] text-[var(--color-primary)]">Sort</p>
                <select
                  value={sortBy}
                  onChange={(event) => {
                    setSortBy(event.target.value as SortFilter);
                  ...
                  >
                    <td className="px-2 py-3 pl-3">
                      <div className="flex min-w-0 items-center gap-2">
                        <div className="flex h-7 w-7 shrink-0 items-center justify-center overflow-hidden rounded-full bg-[var(--color-primary)] font-inter text-[10px] text-[var(--color-secondary)]">
                          {row.avatar_url ? <img src={row.avatar_url} alt={row.first_name || "Customer"} className="h-full w-full object-cover" /> : initials}
                        </div>
                        <p className="truncate font-inter text-[12px] text-[var(--color-navbar-solid-foreground)]" title={fullName}>
                    ...
                    <td className="px-2 py-3 font-inter text-[11px] text-[var(--color-navbar-solid-foreground)]">{(row.total_orders ?? 0).toLocaleString("en-GH")}</td>
                    <td className="px-2 py-3 font-inter text-[11px] text-[var(--color-navbar-solid-foreground)]">{formatCurrency(row.total_spent ?? 0)}</td>
                    <td className="px-2 py-3 font-inter text-[10px] text-[var(--color-muted-soft)]">{formatDateShort(row.created_at)}</td>
                    <td className="px-2 py-3">
                      <span
                        className={`inline-block whitespace-nowrap rounded-full border px-2 py-1 font-inter text-[8px] uppercase tracking-[0.08em] ${
                ...
                rows.flatMap((row) => {
                  ...
                  return [
                    ...
                    >
                      ...
                      <td className="px-2 py-2.5 font-inter text-[11px] text-[var(--color-navbar-solid-foreground)]">{(row.total_orders ?? 0).toLocaleString("en-GH")}</td>
                      <td className="px-2 py-2.5 font-inter text-[11px] text-[var(--color-navbar-solid-foreground)]">{formatCurrency(row.total_spent ?? 0)}</td>
